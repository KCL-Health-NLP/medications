...
annotator = 'Chloe'
#dir_1 = "S:/AchlysShared/BRC_CRIS/Natalia Viani/annotation_prescription/"+annotator+"/dementia/Events_done/"
dir_1 = "T:/Natalia Viani/annotation_prescription/"+annotator+"/dementia/Events_done/"
...
if(write_file):
    ...
    text_file = open("./prescriptions/dementia/output_"+annotator+"_batch1to5"+".txt", "w", encoding = 'utf-8')
